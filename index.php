<?php
    ...
    if(isset($_POST['Add_To_Cart'])){
        ...
        $Image=$_POST['Image'];
        $Quantity=1;
        $select_cart = mysqli_query($conn, "SELECT * FROM `mycart` WHERE Name = '$Name'");

   if(mysqli_num_rows($select_cart) > 0){
    echo '<script> alert("product already added to cart")</script>';
   }else{
      $insert_product = mysqli_query($conn, "INSERT INTO `mycart`(Name , Details, Price, Image, Quantity) VALUES('$Name', '$Details','$Price', '$Image', '$Quantity')");
        ...
        <div class="Menu">
            ...
            <div class="card">
                ...
                <div class="card-link">
                    ...
                    <img src="menu_image/<?php echo $data['Image'];?>" alt="">
